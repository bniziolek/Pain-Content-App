...
- `docs/architecture/ARCHITECTURE_MAP.md`: Non-technical map and feature tours.
- `docs/architecture/ARCHITECTURE_FAQ.md`: FAQ for architectural decisions.
- `docs/architecture/ARCHITECTURE_MIGRATION_TASKS.md`: Migration checklist.
- `docs/architecture/MIGRATION_CHANGELOG.md`: Migration change log.
- `docs/architecture/adrs/README.md`: Architecture Decision Records (ADRs).
